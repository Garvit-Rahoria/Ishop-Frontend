                ...
                brands?.length === 0
                  ...
                  : brands.map((brand) => (
                    ...
                    >
                      ...
                      {/* Status */}
                      <td className="p-4">
                        <StatusBtn value={brand.status} url={`/brand/status-update/${brand._id}`} field="status" />
                      </td>

                      {/* Home */}
                      <td className="p-4">
                        <StatusBtn value={brand.is_home} url={`/brand/status-update/${brand._id}`} field="is_home" />
                      </td>

                      {/* Top */}
                      <td className="p-4">
                        <StatusBtn value={brand.is_top} url={`/brand/status-update/${brand._id}`} field="is_top" />
                      </td>

                      {/* Popular */}
                      <td className="p-4">
                        <StatusBtn value={brand.is_popular} url={`/brand/status-update/${brand._id}`} field="is_popular" />
                      </td>
